...
time python $HOME/fm_solver/picassofiles01main.py $HOME/fm_solver/fm_models/simples/uClinux-distribution_simple.uvl 1048576 ${SLURM_ARRAY_TASK_ID} 128 3600
deactivate
