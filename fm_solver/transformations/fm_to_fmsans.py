...
class FMToFMSans(ModelToModel):
    ...
    def __init__(self, source_model: FeatureModel, n_cores: int, n_tasks: int, current_task: int) -> None:
...
def fm_to_fmsans(feature_model: FeatureModel, n_processes: int = 1, n_tasks: int = 1, current_task: int = 0) -> FMSans:
