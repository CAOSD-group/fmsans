...
cd $HOME/fm_solver/CDL
time python $HOME/fm_solver/picassofiles01main.py $HOME/fm_solver/fm_models/simples/ea2468_simple.uvl 65536 ${SLURM_ARRAY_TASK_ID} 128 86400
deactivate
