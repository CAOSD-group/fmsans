...
from fm_solver.operations import FMConfigurationsNumber, FMConfigurations, FMCoreFeatures, FMFullAnalysis, FMFullAnalysisBDD
...
def main(fm_filepath: str, n_cores: int) -> None:
    ...
    with timer.Timer(name=TIME_ANALYSIS, logger=None):
        result = fmsans_model.get_analysis_bdd(n_cores)
