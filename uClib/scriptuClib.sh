...
#SBATCH --error=OutputR_1_%a-255.err
#SBATCH --output=OutputR_1_%a-255.out
...
time python $HOME/fm_solver/picassofiles01main.py $HOME/fm_solver/fm_models/simples/uClibc_simple.uvl 4194304 ${SLURM_ARRAY_TASK_ID} 256 172200
deactivate
