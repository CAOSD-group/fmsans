...
cd $HOME/fm_solver/uClinuxbase
time python $HOME/fm_solver/picassofiles01main.py $HOME/fm_solver/fm_models/simples/uClinux-base_simple.uvl 65536 ${SLURM_ARRAY_TASK_ID} 128 86400
deactivate
