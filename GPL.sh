...
#SBATCH --error=GPLmain.%A_%a.err
#SBATCH --output=GPLmain.%A_%a.out
...
time python $HOME/fm_solver/00alli1Celerys.py 512 128 120 1200  77371252455336267181195263 "./fm_models/simples/GPL_simple.uvl" "./GPL/GPL_simple.json"
deactivate